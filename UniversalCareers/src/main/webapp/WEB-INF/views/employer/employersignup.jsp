...
<form:form commandName="employer" action="employersignupsubmit" onsubmit="return validate();">
				...
				<tr>
					<td colspan="2">
						<div class="col-md-offset-4 col-md-2">
							<input type="submit" name="employersignup" value="Sign Up!!" class="form-control btn btn-success"/>
						</div>
					</td>
				</tr>
			</tbody>
